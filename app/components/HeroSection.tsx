        ...
        <SafeArea  className='relative'>
            ...
            <div className='pt-32 w-[508px] font-sans '>
              <div className='animate-[slideIn1_0.5s_ease-in-out_1]'>
                ...
                <p className='text-white text-[21px] pt-2'>Nada de perder o controle do seu e-commerce com processos complicados e sistemas confusos que só burocratizam a sua rotina.</p>
              </div>
